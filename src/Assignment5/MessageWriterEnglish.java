...
public class MessageWriterEnglish implements MessageWriter {
    ...
    public String humanDialogCardPick() {
        return "Which card would you like to play input list number or 0 to add a card to your hand";
    }

    @Override
    public String humanSetSuit() {
        return "Which suit would you like to set 1. Spades 2. Hearts 3. Diamonds 4. Clubs";
    }

    @Override
    public String cardNotAllowed() {
        return "The card you selected is not a valid move. Please select a card that matched suit or value of top card.";
    }

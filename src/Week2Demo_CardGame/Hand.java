...
/**
 * An object of type Hand represents a hand of cards. The cards belong to the
 * class Card. A hand is empty when it is created, and any number of cards can
 * be added to it.
 */
public class Hand {
     ...
     * @throws IllegalArgumentException if the position does not exist in the
     * hand, that is if the position is less than 0 or greater than or equal to
     ...
     * are considered to have the lowest value, 1. --- sorting is similar to
     * "selection sort"
     */
